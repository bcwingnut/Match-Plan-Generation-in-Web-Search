...
import os
import warnings
from Benchmarks.experiment_benchmark import train_ero_cont
import torch


@click.command()
@click.option('--env', default='HalfCheetah-v2')  # = Platform-v0 / Goal-v0
@click.option('--seed', default=0)
@click.option('--log_name', default="Cheetah_ero")
...
def run(env,
    ...
    debug = {
            ...
            'demonstration_path': '/data/data0/xuehui/workspace/csh/de/Platform_1.pkl',
    ...
    train_ero_cont(log_name, env, debug,
...
if __name__ == '__main__':
    ...
    gpu_id = 7  # change here to alter GPU id
